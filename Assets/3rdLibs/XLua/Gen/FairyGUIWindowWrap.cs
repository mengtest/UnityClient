...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIWindowWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.Window), L, translator, 0, 12, 11, 6);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.Window), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.Window), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.Window));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.Window), L, translator);
        }
