...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGLoaderWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.GLoader), L, translator, 0, 2, 21, 19);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.GLoader), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.GLoader), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.GLoader));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.GLoader), L, translator);
        }
