...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITextFormatWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.TextFormat), L, translator, 0, 3, 11, 11);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.TextFormat), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.TextFormat), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.TextFormat));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.TextFormat), L, translator);
        }
