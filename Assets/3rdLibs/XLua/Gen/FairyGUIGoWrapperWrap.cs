...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGoWrapperWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.GoWrapper), L, translator, 0, 3, 4, 4);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.GoWrapper), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.GoWrapper), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.GoWrapper));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.GoWrapper), L, translator);
        }
