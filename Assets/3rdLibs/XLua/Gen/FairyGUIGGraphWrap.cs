...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGGraphWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.GGraph), L, translator, 0, 7, 2, 1);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.GGraph), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.GGraph), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.GGraph));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.GGraph), L, translator);
        }
