...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp7(int p0, FairyGUI.GObject p1)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp8(int p0)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new FairyGUI.ListItemRenderer(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(FairyGUI.ListItemProvider))
			{
			    return new FairyGUI.ListItemProvider(__Gen_Delegate_Imp8);
			}
