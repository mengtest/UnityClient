...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUIConfigWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.UIConfig), L, translator, 0, 2, 2, 2);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.UIConfig), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.UIConfig), L, __CreateInstance, 3, 28, 28);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.UIConfig));
			...
			Utils.EndClassRegister(typeof(FairyGUI.UIConfig), L, translator);
        }
