...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGComponentWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.GComponent), L, translator, 0, 32, 16, 10);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.GComponent), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.GComponent), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.GComponent));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.GComponent), L, translator);
        }
