...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIEventDispatcherWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.EventDispatcher), L, translator, 0, 6, 0, 0);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.EventDispatcher), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.EventDispatcher), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.EventDispatcher));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.EventDispatcher), L, translator);
        }
