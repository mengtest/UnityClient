...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUIPackageWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.UIPackage), L, translator, 0, 7, 4, 1);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.UIPackage), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.UIPackage), L, __CreateInstance, 16, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.UIPackage));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.UIPackage), L, translator);
        }
