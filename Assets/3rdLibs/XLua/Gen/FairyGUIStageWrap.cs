...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIStageWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.Stage), L, translator, 0, 14, 10, 3);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.Stage), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.Stage), L, __CreateInstance, 2, 4, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "Instantiate", _m_Instantiate_xlua_st_);
            
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.Stage));
			...
			Utils.EndClassRegister(typeof(FairyGUI.Stage), L, translator);
        }
        ...
        static int _g_get_keyboard(RealStatePtr L)
        {
            ...
            try {
                ...
                FairyGUI.Stage __cl_gen_to_be_invoked = (FairyGUI.Stage)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.keyboard);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
