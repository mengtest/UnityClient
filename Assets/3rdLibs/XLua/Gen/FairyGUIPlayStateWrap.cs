...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIPlayStateWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.PlayState), L, translator, 0, 4, 5, 2);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.PlayState), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.PlayState), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.PlayState));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.PlayState), L, translator);
        }
