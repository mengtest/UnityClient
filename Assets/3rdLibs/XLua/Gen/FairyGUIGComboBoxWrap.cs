...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGComboBoxWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.GComboBox), L, translator, 0, 5, 14, 13);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.GComboBox), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.GComboBox), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.GComboBox));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.GComboBox), L, translator);
        }
