...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGMovieClipWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.GMovieClip), L, translator, 0, 3, 7, 6);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.GMovieClip), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.GMovieClip), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.GMovieClip));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.GMovieClip), L, translator);
        }
