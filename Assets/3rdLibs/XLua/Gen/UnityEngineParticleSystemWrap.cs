...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemWrap
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(typeof(UnityEngine.ParticleSystem), L, __CreateInstance, 2, 0, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "EnableMeshNonUniformScaleFix", _m_EnableMeshNonUniformScaleFix_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_EnableMeshNonUniformScaleFix_xlua_st_(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    bool enabled = LuaAPI.lua_toboolean(L, 1);
                    
                    UnityEngine.ParticleSystem.EnableMeshNonUniformScaleFix( enabled );
