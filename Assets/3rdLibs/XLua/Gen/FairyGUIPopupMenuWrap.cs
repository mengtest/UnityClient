...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIPopupMenuWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.PopupMenu), L, translator, 0, 14, 3, 0);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.PopupMenu), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.PopupMenu), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.PopupMenu));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.PopupMenu), L, translator);
        }
