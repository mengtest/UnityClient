...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIScrollPaneWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.ScrollPane), L, translator, 0, 18, 31, 18);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.ScrollPane), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.ScrollPane), L, __CreateInstance, 1, 1, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.ScrollPane));
			Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "draggingPane", _g_get_draggingPane);
            
			
			Utils.EndClassRegister(typeof(FairyGUI.ScrollPane), L, translator);
        }
