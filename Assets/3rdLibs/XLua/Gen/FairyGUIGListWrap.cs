...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGListWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.GList), L, translator, 0, 28, 22, 17);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AdjustItemsSize", _m_AdjustItemsSize);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.GList), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.GList), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.GList));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.GList), L, translator);
        }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AdjustItemsSize(RealStatePtr L)
        {
            ...
            try {
                
                {
                    ...
                    __cl_gen_to_be_invoked.AdjustItemsSize(  );
