...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineMeshWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Mesh), L, translator, 0, 36, 19, 15);
            ...
            try {
                
                {
                    int index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        System.IntPtr __cl_gen_ret = __cl_gen_to_be_invoked.GetNativeVertexBufferPtr( index );
        ...
        static int _m_GetTriangles(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    int submesh = LuaAPI.xlua_tointeger(L, 2);
                    bool applyBaseVertex = LuaAPI.lua_toboolean(L, 3);
                    
                        int[] __cl_gen_ret = __cl_gen_to_be_invoked.GetTriangles( submesh, applyBaseVertex );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 4&& translator.Assignable<System.Collections.Generic.List<int>>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    System.Collections.Generic.List<int> triangles = (System.Collections.Generic.List<int>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<int>));
                    int submesh = LuaAPI.xlua_tointeger(L, 3);
                    bool applyBaseVertex = LuaAPI.lua_toboolean(L, 4);
                    
                    __cl_gen_to_be_invoked.GetTriangles( triangles, submesh, applyBaseVertex );
            ...
            try {
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool applyBaseVertex = LuaAPI.lua_toboolean(L, 3);
                        ...
                        int[] __cl_gen_ret = __cl_gen_to_be_invoked.GetIndices( submesh, applyBaseVertex );
                        translator.Push(L, __cl_gen_ret);
                ...
                if(__gen_param_count == 4&& translator.Assignable<System.Collections.Generic.List<int>>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    __cl_gen_to_be_invoked.GetIndices( indices, submesh, applyBaseVertex );
            ...
            try {
                
                {
                    int submesh = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        uint __cl_gen_ret = __cl_gen_to_be_invoked.GetBaseVertex( submesh );
                        LuaAPI.xlua_pushuint(L, __cl_gen_ret);
        ...
        static int _m_SetTriangles(RealStatePtr L)
        {
            ...
            try {
                ...
                if(__gen_param_count == 5&& translator.Assignable<int[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    int[] triangles = (int[])translator.GetObject(L, 2, typeof(int[]));
                    int submesh = LuaAPI.xlua_tointeger(L, 3);
                    bool calculateBounds = LuaAPI.lua_toboolean(L, 4);
                    int baseVertex = LuaAPI.xlua_tointeger(L, 5);
                    
                    __cl_gen_to_be_invoked.SetTriangles( triangles, submesh, calculateBounds, baseVertex );
                    
                    
                    
                    return 0;
                }
                if(__gen_param_count == 5&& translator.Assignable<System.Collections.Generic.List<int>>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    System.Collections.Generic.List<int> triangles = (System.Collections.Generic.List<int>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<int>));
                    int submesh = LuaAPI.xlua_tointeger(L, 3);
                    bool calculateBounds = LuaAPI.lua_toboolean(L, 4);
        ...
        static int _m_SetIndices(RealStatePtr L)
        {
            ...
            try {
                ...
                if(__gen_param_count == 6&& translator.Assignable<int[]>(L, 2)&& translator.Assignable<UnityEngine.MeshTopology>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    int[] indices = (int[])translator.GetObject(L, 2, typeof(int[]));
                    UnityEngine.MeshTopology topology;translator.Get(L, 3, out topology);
                    int submesh = LuaAPI.xlua_tointeger(L, 4);
                    bool calculateBounds = LuaAPI.lua_toboolean(L, 5);
                    int baseVertex = LuaAPI.xlua_tointeger(L, 6);
                    
                    __cl_gen_to_be_invoked.SetIndices( indices, topology, submesh, calculateBounds, baseVertex );
        ...
        static int _g_get_indexFormat(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Mesh __cl_gen_to_be_invoked = (UnityEngine.Mesh)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.indexFormat);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_indexFormat(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.Mesh __cl_gen_to_be_invoked = (UnityEngine.Mesh)translator.FastGetCSObj(L, 1);
                UnityEngine.Rendering.IndexFormat __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.indexFormat = __cl_gen_value;
