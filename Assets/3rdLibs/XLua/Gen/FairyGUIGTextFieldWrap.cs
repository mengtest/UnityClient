...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGTextFieldWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.GTextField), L, translator, 0, 2, 14, 12);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.GTextField), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.GTextField), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.GTextField));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.GTextField), L, translator);
        }
