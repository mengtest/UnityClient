...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITimersWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.Timers), L, translator, 0, 7, 0, 0);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.Timers), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.Timers), L, __CreateInstance, 1, 4, 3);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.Timers));
			...
			Utils.EndClassRegister(typeof(FairyGUI.Timers), L, translator);
        }
