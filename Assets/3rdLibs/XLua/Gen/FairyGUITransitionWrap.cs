...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITransitionWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(FairyGUI.Transition), L, translator, 0, 11, 7, 5);
			...
			Utils.EndObjectRegister(typeof(FairyGUI.Transition), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(FairyGUI.Transition), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(FairyGUI.Transition));
			
			
			Utils.EndClassRegister(typeof(FairyGUI.Transition), L, translator);
        }
